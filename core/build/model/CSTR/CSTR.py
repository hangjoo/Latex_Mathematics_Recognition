    ...
    body=dict(
        ...
        pipelines=[
                ...
                arch=dict(
                    encoder=dict(
                        backbone=dict(
                            ...
                            layers=[
                                dict(
                                    type="ConvModule", in_channels=3, out_channels=32 + base_channel, kernel_size=3, stride=1, padding=1, norm_cfg=norm_cfg
                                ),  # 48, 192
                                dict(
                                    type="ConvModule",
                                ...
                                dict(
                                    ...
                                    norm_cfg=norm_cfg,
                                    plug_cfg=dict(
                                        type="CBAM", gate_channels=128 + base_channel * 4, reduction_ratio=16, norm_cfg=dict(type="BN", momentum=0.01)
                                    ),
                                ),
                                # 24, 96
                                dict(
                                ...
                                dict(
                                    ...
                                    norm_cfg=norm_cfg,
                                    plug_cfg=dict(
                                        type="CBAM", gate_channels=256 + base_channel * 8, reduction_ratio=16, norm_cfg=dict(type="BN", momentum=0.01)
                                    ),
                                ),
                                # 12, 48
                                dict(
                                ...
                                dict(
                                    ...
                                    norm_cfg=norm_cfg,
                                    plug_cfg=dict(
                                        type="CBAM", gate_channels=512 + base_channel * 16, reduction_ratio=16, norm_cfg=dict(type="BN", momentum=0.01)
                                    ),
                                ),
                                # 6, 24
                                dict(
                        ...
                        neck=[
                            ...
                            dict(
                                ...
                                top_down=dict(
                                    ...
                                    upsample=dict(type="Upsample", size=(6, 24), scale_bias=0, mode="bilinear", align_corners=True,),
                                ),
                                lateral=None,
                                post=None,
                                to_layer="p5_1",
                            ...
                            dict(
                                ...
                                top_down=dict(
                                    ...
                                    upsample=dict(type="Upsample", size=(12, 48), scale_bias=0, mode="bilinear", align_corners=True,),
                                ),
                                lateral=None,
                                post=None,
                                to_layer="p5_2",
            ...
            dict(
                ...
                arch=dict(
                    encoder=dict(backbone=dict(type="GBackbone", layers=[dict(type="NonLocal2d", in_channels=512, sub_sample=True,)]),),  # c0
...
class CSTR(nn.Module):
    def __init__(self, FLAGS, tokenizer):
    ...
    def forward(self, input, expected, is_train, teacher_forcing_ratio):
        ...
        target_length = expected.size()[-1] - 1
